...
jsonstuff <- '[
    ...
    {
        "xvar" : "time",
        "yvar" : ["mean_b1","mean_b2"]
    },
    {
        "xvar" : "time",
        "yvar" : ["mean_alpha","mean_alpha_m","mean_alpha_int","mean_alpha_grad"]
    },
    {
        "xvar" : "time",
        "yvar" : ["mean_v","mean_v_int","mean_v_grad"]
    },
    {
        "xvar" : "time",
        "yvar" : ["var_b1","var_b2"]
    ...
    {
        "xvar" : "time",
        "yvar" : ["var_alpha_m","var_alpha_int","var_alpha_grad"]
    },
    {
        "xvar" : "time",
        "yvar" : ["var_alpha","var_alpha_m","var_alpha_int","var_alpha_grad"]
    },
    {
        "xvar" : "time",
        "yvar" : ["var_v","var_v_int","var_v_grad"]
    },
    {
        "xvar" : "time",
        "yvar" : ["var_birth","var_division","var_divT"]
    }
]
'
